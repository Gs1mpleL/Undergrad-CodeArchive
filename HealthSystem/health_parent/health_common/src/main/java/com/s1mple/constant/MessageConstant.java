...
public class MessageConstant {
    public static final String CHECK_CHECKGROUP_CHECKITEM_CONN_FAIL = "获取关联检查项失败";
    public static final String CHECK_CHECKGROUP_CHECKITEM_CONN_SUCCESS = "获取关联检查项成功";
    public static final String DELETE_CHECKGROUP_CHECKITEM_FAIL = "该项目已经进入检查组，无法直接删除！";
